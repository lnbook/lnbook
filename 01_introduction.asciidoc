...
The Lightning Network proposes a new network, a "second layer", where users can make payments to each other peer-to-peer, without the necessaty to publish a transaction to the Bitcoin blockchain every time.
