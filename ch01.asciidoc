...
With this mechanism a user A could fund a multisig transaction between A and another user B together with a timelocked transaction sending all Bitcoin Back to A.
