...
Since A never has both signatures for a spend of the multisignature wallet besides the timelocked refund transaction, A would have no interest in publishing an old state since a newer state would send more money to B.
