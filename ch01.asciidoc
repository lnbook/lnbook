...
* Multiple white papers (Joseph Poon, Thaddeus Dryja - https://lightning.network/lightning-network-paper.pdf) / Christian Decker
...
* Lightning.place / The lightning torch
* today
