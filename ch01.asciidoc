...
Custodial solutions are where a 3rd party has ownership (custody) of your assets, and provides you a service based on this. Custodial solutions are familiar to anyone who has a bank account. In an ideal world, non-custodial lightning networs solutions would be easy enough to use that custodial solutions are not necessary, however in the current state of the crypto-currency lifecycle, there is a place for custodial solutions.  This book will not recommend any specific custodial solutions, however they may be a starting place for people wishing to experiement with the technology. 

Custodial solutions typically run a full-node and lightning implementation in the background, and provide a front end user-interface for customers to send and receive lightning bitcoins.  

Users of custodial solutions must always be aware that their money and bitcoin are provided to them at the behest of someone else. "not your keys, not your bitcoin". 
