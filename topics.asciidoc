...
* mentioning that the Lightning Network is one solution to the scaling question, besides others (sidechains for example liquid).
* mentioning the trilemma security, decentralisation and scalability and why this leads to the second layer solution.
* comparison to a fiat scaling network for example Visa (also second layer solution to the fiat system) and why the Lightning Network is much more sophisticated.
