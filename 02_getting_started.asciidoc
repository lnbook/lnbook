...
To reclaim your privacy and stay anonymous online, it is recommended to use The Onion Router (TOR) Browser footnote:[TOR Project can help you to defend yourself against tracking and surveillance and circumvent censorship  (https://www.torproject.org/download/).]
...
| Electum        | Desktop | Lightweight | Electrum              | Self-Custody
