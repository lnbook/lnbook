...
[cols="2*"]
|===
|When Alice opens the Eclair Mobile app for the first time, she is presented with a choice to "CREATE NEW WALLET" or "RESTORE WALLET". Alice will create a new wallet.
|[]
image::images/eclair1.png["CREATE NEW WALLET" or "RESTORE WALLET",width=300]
|===
