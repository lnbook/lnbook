...
=== List of exchanges that support LN

* https://submarineswaps.org/ Trade on-chain tokens for Lightning invoice payments
* https://boltz.exchange/ Atomic Swaps
* https://xmr.to/ XMR to BTC-LN
* https://bitflash.club/ Joining multiple Lightning transactions into a single on-chain transaction
* https://ln.bitfinex.com/ Famous crypto exchange that supports LN deposits and withdrawals
* https://t.me/lnswapbot Telegram bot
* https://fixedfloat.com/
* https://zigzag.io/
* https://lnmarkets.com/ Derivatives
