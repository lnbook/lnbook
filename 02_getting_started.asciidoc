...
From all features the two most important criteria are LN Node use and fund custody. Correspondingly the two most important questions to ask about a specific wallet are:
...
From these two questions we can derive four possible categories. We can place these four categories into a quadrant as seen in Table <<lnwallet-categories>>. 
...
| *Self-Custody*         | Q1: High technical skill | Q2: Medium technical skills 
| *Custodial*            | Q3: not a common wallet type | Q4: Low technical skills 
|===

Q3, quadrant 3, where a full LN node is used but the keys are held by a custodian is not common. A user who goes through the effort of running a Ligtning Node will most likely also put in the additional efffort to store his own keys. 
...
| Zap Desktop    | Desktop | Full Node   | Bitcoin Core/btcd     | Self-Custody
| Eclair Mobile  | Mobile  | Lightweight | Electrum              | Self-Custody
| Breez Wallet   | Mobile  | Full Node   | Bitcoin Core/btcd     | Self-Custody
