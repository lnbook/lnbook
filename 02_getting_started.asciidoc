...
|When Alice opens the Eclair Mobile app for the first time, she is presented with a choice to "CREATE NEW WALLET" or "RESTORE WALLET". 
...
|===
|[]
image::images/eclair10.png["10",width=300]
|line one. 
...
|===
|[]
image::images/eclair11.png["11",width=300]
|line one. 
