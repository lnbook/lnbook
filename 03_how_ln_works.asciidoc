...
A Protocol Breach can be executed faster than a mutual close, as you do not need to agree to a close with your partner or wait for routing attempts to resolve or expire, and faster than a force close as you do not need to wait for your timelock to expire.
