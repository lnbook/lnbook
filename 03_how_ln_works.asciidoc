...
Hence, the two different pricing models, each one according to its scarcity. 
Bitcoin transaction fees pay for block space. 
Lightning transaction fees pay for channel capacity. 
