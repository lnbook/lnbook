...
Hence, the two different pricing models, each one influenced by its scarcity. 
Bitcoin transaction fees pay primarily for block space. 
Lightning transaction fees pay by and large for channel capacity. 
