...
The short channel id is set to 0 signaling Gloria that this payment is intended to be for him.
Note that this example is slightly simplified, in that Gloria can also use attributes of the onion packet format itself to be able to know when he's the final hop.
