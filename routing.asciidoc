...
Thus after Wei decrypts his layer he can use the shared secret and his ephemeral public key to derive the ephemeral public key that Gloria is supposed to use and store it in the header of the Onion that he forwards to Gloria.
