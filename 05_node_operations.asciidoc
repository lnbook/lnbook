...
If you don't want it to automatically activate when you start +lightningd+, you can place it in a different directory, and then when you want to activate it you can use the +plugin+ argument when starting +lightningd+:
