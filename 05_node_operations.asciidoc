...
[NOTE]
====
Running a profitable business by operating a Lightning node is definitely _not_ easy. 
If one plans to operate a Lightning node _solely_ to gain income by earning routing fees,
it is important to form your performance expectations based on the facts available.
Calculate all your initial and ongoing costs in a spreadsheet. Study Lightning Network statistics carefully.
...
but in one of the several other reasons listed above.
====
