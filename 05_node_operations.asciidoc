...
((("hardware, Lightning node")))((("Lightning node operation","hardware requirements")))At a minimum, the following will be required to run a Lightning node:
...
Umbrel is currently still in beta and not considered secure.(((range="endofrange", startref="ix_05_node_operations-asciidoc5")))(((range="endofrange", startref="ix_05_node_operations-asciidoc4")))
...
((("hot wallets","sweeping funds")))((("sweeping funds","hot wallets")))If your Lightning wallet balance becomes too large for your risk tolerance, you will need to "sweep" funds out of the wallet. You can do so in three ways: on-chain, off-chain, and Loop Out. Let's look at each one of these options in the next few sections. 
